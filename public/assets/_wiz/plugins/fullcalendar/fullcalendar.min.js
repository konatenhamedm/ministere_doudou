...
var FullCalendar = function (e) {
	...
	function ie(e) {
		...
		return e.children
	}, ne.prototype.componentDidUpdate = ne.prototype.componentDidRount = function () {
		var e = this;
	...
	var me = function (e) {
		...
		return n(t, e), t.prototype.render = function () {
			return v("div", {})
		}, t.prototype.componentDidRount = function () {
			this.setState({})
		}, t
	}(y);
	var ye = function () {
	...
	var is = function (e) {
		return _o(Oo.Consumer, null, (function (t) {
			...
			return _o(Yo, {
				...
				didRount: n.nowIndicatorDidRount,
	...
	var Bs = function (e) {
		function t(n) {
			...
			o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validRutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
				...
				if (o.isDragging) {
					...
					o.displayDrag(a, c), u ? Ue() : We(), t || (i === a && Us(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !Te(o.subjectEl).querySelector(".fc-event-mirror")), o.receivingContext = a, o.validRutation = s, o.mutatedRelevantEvents = l)
				}
		...
		return n(t, e), t.prototype.destroy = function () {
			...
			this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validRutation = null, this.mutatedRelevantEvents = null
		}, t.SELECTOR = ".fc-event-draggable, .fc-event-resizable", t
	}(ea);
	var zs = function (e) {
		function t(t) {
			var n = e.call(this, t) || this;
			n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validRutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
				var t = n.component,
					r = Jn(n.querySegEl(e)),
				...
				}), c ? Ue() : We(), t || (l && Us(a, e) && (l = null), n.validRutation = l, n.mutatedRelevantEvents = u)
			}, n.handleDragEnd = function (e) {
				var t = n.component.context,
					o = n.eventRange.def,
				...
				if (t.emitter.trigger("eventResizeStop", {
					...
					t.emitter.trigger("eventResize", r(r({}, c), {
						el: n.draggingSegEl,
						startDelta: n.validRutation.startDelta || Nt(0),
						endDelta: n.validRutation.endDelta || Nt(0),
						jsEvent: e.origEvent,
						view: t.viewApi
					})), t.emitter.trigger("eventChange", c)
				} else t.emitter.trigger("_noEventResize");
				n.draggingSeg = null, n.relevantEvents = null, n.validRutation = null
			};
			var o = t.component,
				i = n.dragging = new Os(t.el);
